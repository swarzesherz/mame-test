...
ROM_START( mkfr )
	ROM_REGION( 0x50000, "adcpm", 0 ) 	/* sound CPU */
	ROM_LOAD( "mks-u3.rom", 0x10000, 0x40000, CRC(c615844c) SHA1(5732f9053a5f73b0cc3b0166d7dc4430829d5bc7) )
...
/* Hack */
GAME( 1992, mkfr,     mk,      tunit_adpcm, mk,       mktunit,  ROT0, "Midway",   "Mortal Kombat (French Edition)", GAME_SUPPORTS_SAVE )
GAME( 1993, mk2fr,    mk2,     tunit_dcs,   mk2,      mk2,      ROT0, "hack",   "Mortal Kombat II (French - Arkatrad)", GAME_SUPPORTS_SAVE )
