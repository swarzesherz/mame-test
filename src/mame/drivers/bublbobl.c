...
ROM_START( bublbofr )
	ROM_REGION( 0x30000, "maincpu", 0 )
	ROM_LOAD( "a78-06-1.51fr",    0x00000, 0x08000, CRC(9ced3d8f) SHA1(d445f218fca822e7083a9347abd4a4e049b6555b) )
    /* ROMs banked at 8000-bfff */
	ROM_LOAD( "a78-05-1.52fr",    0x10000, 0x10000, CRC(b8f43b09) SHA1(96abd923e712078c70a452ba51513577cc0bdb08) )
	/* 20000-2ffff empty */
...
/* Hack */
GAME( 1986, bublbofr, bublbobl, bublbobl, bublbobl, bublbobl, ROT0,  "hack", "Bubble Bobble (French - Arkames Traduction)", 0 )
