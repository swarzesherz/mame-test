...
ROM_START( thkanwcg )
	...
	ROM_LOAD( "twc-1h.bin",   0x0000, 0x4000, CRC(0686377f) SHA1(69c4d63c216e0b640ad514568a07c414a94bae7c) )
	ROM_LOAD( "twc-2.bin",    0x4000, 0x4000, CRC(7017a221) SHA1(4b4700af0a6ff64f976db369ba4b9d97cee1fd5f) )
	ROM_LOAD( "twc-3h.bin",   0x8000, 0x4000, CRC(9a10118d) SHA1(1319e465620ab297bf70aed6eed426b68580a327) )

	ROM_REGION( 0x10000, "sub", 0 )	/* 64k for code */
	ROM_LOAD( "twc-4h.bin",   0x0000, 0x8000, CRC(8a13d6ac) SHA1(cc9b7a0836d6b4ff5f037a165451f6cf2f967d21) )

	ROM_REGION( 0x10000, "audiocpu", 0 )	/* 64k for code */
	ROM_LOAD( "twc-6.bin",    0x0000, 0x4000, CRC(e3112be2) SHA1(7859e51b4312dc5df01c88e1d97cf608abc7ca72) )

	ROM_REGION( 0x04000, "gfx1", ROMREGION_DISPOSE )
	ROM_LOAD( "twc-12h.bin",  0x00000, 0x4000, CRC(17808225) SHA1(259c0162c4eef4eceb889f4a1a142b541376e04d) )	/* fg tiles */
	...
	ROM_REGION( 0x10000, "gfx3", ROMREGION_DISPOSE )
	ROM_LOAD( "twc-11h.bin",  0x00000, 0x8000, CRC(ceab1e34) SHA1(f803965ef8b69a5951656f890f0e411dfdeef7ab) )	/* bg tiles */
	ROM_LOAD( "twc-9h.bin",   0x08000, 0x8000, CRC(b120fbee) SHA1(a7012ec3ecbedfb3d04477bdda6f87f1fe819919) )
...
GAME( 2004, thkanwcg, tehkanwc, tehkanwc, tehkanwc, 0, 	      ROT0,  "Hack", "Tehkan World Cup (Greek)", 0 )
