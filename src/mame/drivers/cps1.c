...
static ADDRESS_MAP_START( maincpu_map, ADDRESS_SPACE_PROGRAM, 16 )
...
//mamep: no valid audiocpu rom dump, hack it to run on qsound hw
...
1x MC68000P12 (maincpu)
1x TPC1020AFN-084C (maincpu)
...
/* this is basically the same set as above, from a different bootleg pcb, with a few extra pal dumps etc.
  ...
  CPU
  1x TS68000CP10 (maincpu)
  1x AD-65 (sound)(equivalent to M6295)
  1x PIC16C57-XT/P
  1x A1020B-PL84C
  1x oscillator 24.000MHz (close to maincpu)
...
ROM_START( hwofah )
	...
	ROM_LOAD16_WORD_SWAP( "tk2ah_22b.rom",  0x080000, 0x80000, CRC(48fd83c6) SHA1(8f33124979d7ca4c2af10f2a98b524e5463458cc) )
...
ROM_START( punishrb )
	...
	ROM_LOAD( "sound.bin",          0x00000, 0x80000, CRC(aeec9dc6) SHA1(56fd62e8db8aa96cdd242d8c705849a413567780) )
	ROM_LOAD( "ps_q.rom",       0x00000, 0x08000, CRC(49ff4446) SHA1(87af12f87a940a6c5428b4574ad44a4b54867bc3) )
	ROM_CONTINUE(               0x10000, 0x18000 )
...
ROM_START( sfzbch )
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "sfzbrh23",       0x000000, 0x80000, CRC(53699f68) SHA1(d7f132faf8c31b5e79c32e6b0cce45377ec8d474) )
	ROM_LOAD16_WORD_SWAP( "sfza22",         0x080000, 0x80000, CRC(8d9b2480) SHA1(405305c1572908d00eab735f28676fbbadb4fac6) )
	ROM_LOAD16_WORD_SWAP( "sfzch21",        0x100000, 0x80000, CRC(5435225d) SHA1(6b1156fd82d0710e244ede39faaae0847c598376) )
	ROM_LOAD16_WORD_SWAP( "sfza20",         0x180000, 0x80000, CRC(806e8f38) SHA1(b6d6912aa8f2f590335d7ff9a8214648e7131ebb) )
...
/* Extra Ash-Build */
GAME( 1994, pnicku,   pnickj,   cps1_10MHz, pnickj,   cps1,     ROT0,   "Compile (Capcom license)", "Pnickies (US 940608)", 0 )
GAME( 1992, hwofa,    wof,      qsound,     wof,      wof,      ROT0,   "hack",   "Sangokushi II (Asia)(Hack set 1)", 0 )
GAME( 1992, hwofah,   wof,      qsound,     wof,      wof,      ROT0,   "hack",   "Sangokushi II (Asia)(Hack set 2)", GAME_IMPERFECT_GRAPHICS )
GAME( 1991, knights2, knights,  cps1_10MHz, knightsh, cps1,     ROT0,   "hack",   "Knights of the Round (hack set 2)", 0 )
GAME( 1989, dynwarjh, dynwar,   cps1_10MHz, dynwar,   cps1,     ROT0,   "hack",   "Tenchi wo Kurau (Japan)(Hack set 1)", GAME_IMPERFECT_GRAPHICS )
GAME( 1989, dynwrj2,  dynwar,   cps1_10MHz, dynwar,   cps1,     ROT0,   "hack",   "Tenchi wo Kurau (Japan)(Hack set 2)", GAME_IMPERFECT_GRAPHICS )
GAME( 1992, wofjh,    wof,      qsound,     wof,      wof,      ROT0,   "hack",   "Tenchi wo Kurau II - Sekiheki no Tatakai (Japan Hack)", 0 )
GAME( 1992, sf2cebr,  sf2ce,    cps1_12MHz, sf2,      sf2hack,  ROT0,   "Capcom", "Street Fighter II' - Champion Edition (Brasil 920313)", 0 ) 
GAME( 1992, sf2turyu, sf2ce,    cps1_12MHz, sf2hack,  sf2hack,  ROT0,   "bootleg","Street Fighter II' - Champion Edition (Turyu)", 0 )	
GAME( 1999, sf2ceh,   sf2ce,    cps1_12MHz, sf2,      sf2hack,  ROT0,   "hack",   "Street Fighter II' - Champion Edition (Hispanic 990804)", 0 )
GAME( 1991, captcomh, captcomm, cps1_10MHz, captcomm, cps1,     ROT0,   "hack", "Captain Commando (World 911014, Hack by Shinwa)" , 0)				
GAME( 1993, punisrjh, punisher, qsound,     punisher, punisher, ROT0,   "hack", "The Punisher (Japan 930422, Hack by Shinwa)" , 0)	
GAME( 1993, punishrb, punisher, qsound,     punisher, punishrb, ROT0,   "bootleg","The Punisher (bootleg)", 0 )

/* CPS Changer */
GAME( 1995, sfzch,    0,        cps1_10MHz, sfzch,    cps1,     ROT0,   "Capcom", "Street Fighter Zero (CPS Changer Japan 951020)", 0 )
GAME( 1995, sfach,    sfzch,    cps1_10MHz, sfzch,    cps1,     ROT0,   "Capcom", "Street Fighter Alpha (Publicity US 950727)", 0 )
GAME( 1995, sfzbch,   sfzch,    cps1_10MHz, sfzch,    cps1,     ROT0,   "hack",   "Street Fighter Zero (CPS Changer Brazil 950727)", 0 )
